...
<div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 flex justify-center">
        <form class="bg-white w-full" action="{{route('admin.users.create.action')}}" method="POST">
          @csrf
          ...
          <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
            <select name="role"  class="pl-2 focus:ring-0 focus:border-1 focus:border-gray-300 border-none placeholder-slate-500" >
